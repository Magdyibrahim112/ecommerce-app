        ...
        child: BlocConsumer<CartCubit, CartState>(
          listener: (context, state) {
            if(state is UpdateCartProductQuantityLoading
                || state is DeleteProductQuantityFromCartLoading){
              UIUtils.showLoading(context);
            }else if(state is UpdateCartProductQuantitySuccess
            || state is DeleteProductQuantityFromCartSuccess){
            ...
            }else if(state is DeleteProductQuantityFromCartError){
              UIUtils.hideDialog(context);
              UIUtils.showToastMessage(state.message, Colors.red);
            }
          },
                  ...
                  Expanded(
                    ...
                    child: ListView.separated(
                      itemBuilder: (context, index) => CartItemWidget(
                        ...
                        price: 1500,
                        quantity: 1,
                        //cartCubit.cart.cartItems[index].count
                        onDeleteTap: () {},
