...
late CartEntity cart;
  ...
  void updateCartProduct({required String productId, required String quantity})async{
    emit(UpdateCartProductQuantityLoading());
    var result = await updateCartProductQuantityUseCase(productId: productId, quantity: quantity);
  result.fold((failure){
