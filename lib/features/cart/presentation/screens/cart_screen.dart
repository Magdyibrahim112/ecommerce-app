      ...
      body: Padding(
        ...
        child: BlocConsumer<CartCubit, CartState>(
          listener: (context, state){
            ...
            }else if(state is UpdateCartProductQuantitySuccess || state is DeleteProductFromCartSuccess){
          ...
          builder: (context, state){
            ...
            return cartCubit.cart.cartItems.isEmpty ? Center(child: Text("Cart is Empty"),): Column(
              children: [
                Expanded(
