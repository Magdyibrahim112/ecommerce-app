        ...
        child: Padding(
          ...
          child:
            ...
            ProductRating(
                ...
                productBuyers: "${widget.product.sold ?? 0}" , productRating: '${widget.product.ratingsAverage} (${widget.product.ratingsQuantity ?? 0})'),
            SizedBox(
              height: 16.h,
            ),
            ProductDescription(
                ...
                Expanded(
                  child: BlocListener<CartCubit, CartState>(
                    listener: (context2, state) {
                      ...
                      }else if(state is AddToCartSuccess) {// in success state
                        UIUtils.hideDialog(context2);
