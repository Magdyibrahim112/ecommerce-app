              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        cartCubit.deleteProductFromCart(productId: cartItemEntity.product.id);
                      },
                      child: Image.asset(
                ...
                Row(
                  children: [
                    ...
                    ProductCounter(
                      add: (quantity){
                       quantity++;
                       cartCubit.updateCartProduct(productId: cartItemEntity.product.id, quantity: quantity.toString());
                      },
